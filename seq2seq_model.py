...
{\*\expandedcolortbl;;}
\paperw11900\paperh16840\margl1440\margr1440\vieww20700\viewh8400\viewkind0
\pard\tx566\tx1133\tx1700\tx2267\tx2834\tx3401\tx3968\tx4535\tx5102\tx5669\tx6236\tx6803\pardirnatural\partightenfactor0

\f0\fs24 \cf0 from keras.preprocessing.sequence import pad_sequences\
...
\
        ...
        # and this results in NaN's. A workaround is to add a very small positive number \uc0\u949  to the sum.\
...
\
#This is for beijin city number, can change by yourself\
def weather_model(station_num=35,MAX_time_step=60,grid_station_num=100,feature_num=20):\
...
\
\
def mapping_extractor(MAX_time_step=60):\
